  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="CompanyController as ctrl">
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.company.companyname" name="cname" class="companyname form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.company.address" class="form-control input-sm" placeholder="Enter your Address. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-heading"><span class="lead">List of Companys </span></div>
              <div class="tablecontainer">
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.companys">
